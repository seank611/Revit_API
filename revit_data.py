# Revit_dataV1.py V1.2 **copyright property of Sean Kelton**
# 9/23/2021
...
param_doubles = ['Area', 'Volume', 'Thickness', 'Length', 'Cut Length']
headers = ['Element Id', 'Element Name', 'Structural Material', 'Family', 'Structural?', 'Category', 'Type',
           'Phase Created', 'Structural Usage', 'Level', 'Reference Level', 'Area', 'Volume', 'Thickness', 'Length', 'Cut Length']
